...
public class SampleController {
     ...
     */
    @GetMapping("/ex2")
    public void ex2(@RequestParam(name="naming", defaultValue = "AAAA") String name,
        ...
        String name 과 int age는 request의 공간에 자동으로 저장 공유된다.
         */
    }
    ...
    public void ex4(Model model){
        ...
        // modle에 추가한 값을 꺼내서 request에 저장한다.
    ...
    public String ex5(RedirectAttributes redirectAttributes){
        ...
        // 서버가 재접속 명령을 브라우저한테 보냈을 때 1번만 사용할 수 있는 1회성 데이터
        redirectAttributes.addFlashAttribute("result", "success");

        // 리턴값이 존재하면 jsp로 전달되는 것이 아니고
        // 브랄우저한테 아래 주소로 재접속을 하도록 하는 것
        return "redirect:/ex6";
    }
    @GetMapping("/ex6")
    public void ex6(){
